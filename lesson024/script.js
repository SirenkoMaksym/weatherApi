...
async function loadCityes() {
    const res = await fetch('https://sirenkomaksym.github.io/ferrari/cities.json')
    ...
    data.map(e => {
        ...
        // const formLat = document.createElement('p')
        // formLat.textContent = latitude
        // const formLong = document.createElement('p')
        // formLong.textContent= longitude
        ...
        setTimeout(() => {
            ...
            card.append(formBild, formCity, formtemp, formSpeed, formCode,formDesc)
            form.append(card)
        }, 1500)
    }
    uploadWeather() 
